...
export declare namespace backupdr_v1 {
    ...
    export class Resource$Projects$Locations$Trial {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        end(params: Params$Resource$Projects$Locations$Trial$End, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        end(params?: Params$Resource$Projects$Locations$Trial$End, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Trial>>;
        end(params: Params$Resource$Projects$Locations$Trial$End, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        end(params: Params$Resource$Projects$Locations$Trial$End, options: MethodOptions | BodyResponseCallback<Schema$Trial>, callback: BodyResponseCallback<Schema$Trial>): void;
        end(params: Params$Resource$Projects$Locations$Trial$End, callback: BodyResponseCallback<Schema$Trial>): void;
